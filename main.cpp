...
void TestAddHead()
{
	...
	//testing copy
	cout << "DEBUG: Printing list copied by LinkedList<int> data2=data1" << endl;
	cout << endl << "Original List : " << endl;
	data.PrintForward();
	cout << endl << "Copied List : " << endl;
	LinkedList<int> data2 = data;
	data2.PrintForward();
	cout << endl << "Node Count of Data2 "<< data2.node_count << " Node Count of Data1 " << data.node_count << endl;
	cout << endl << "Address of data2.head "<< data2.head << " Address of data1.head " << data.head << endl;
	cout << endl << "Address of data2.tail " << data2.tail << " Address of data1.tail " << data.tail << endl;
